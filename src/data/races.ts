export const RACES = {
  races: [
    ...
    },
    {
      ...
      description:
        "Pre-industrial society encountered by the Enterprise NX-01.",
      name: "Akaali",
    ...
    },
    {
      ...
      description:
        "Advanced humanoid Delta Quadrant race with basic interstellar spaceflight, perhaps warp-capable. A dictatorship controls the planet, now dealing with an Open Sky group fighting to overthrow it.",
      name: "Akritirians",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Unspecified race that had a transport operating from Deep Space 4 to Caere on stardate 46731.5.",
      name: "Al-Leyan",
    ...
    },
    {
      ...
      description:
        "A large woolly mammal of this world. Garak once absorbed 30 cc's of an anesthetic that would have knocked out such a beast, according to Bashir.",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "A previously unknown, telepathically linked and allasomorphic race who kidnapped Picard, a Mizarian and a Chalnoth like lab rats in 2366 in order to study the concept of leadership, which they lack.",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "It may or may not be species-related, but suspicious character Villus Thed has short-range telepathic powers up to five meters away.",
      name: "Aliens, Thed",
    ...
    },
    {
      serie: "Star Trek: Voyager",
      description:
        "The Alsaurians are treated as an under-class by the Mokra, which have seized control of the Alsaurian planet.  The Mokra do not allow them to have communications equipment.",
      name: "Alsaurians",
    ...
    },
    {
      ...
      description:
        "Origin: space. A giant single-celled creature which resembles an Earth amoeba but is magnified millions of times.",
      name: "Amoeba",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "The homeworld to an intellgient, spacefaring UFP member race  also fosters  a species of avian vulture known to Constable Odo; he is exhilarated when morphing into its form and flying around on his homeworld.",
      name: "Arbazan",
    ...
    },
    {
      serie: "Star Trek: The Original Series",
      description:
        "Planet: Argelius II. Despite the hedonistic nature of the natives of Argelius II, their planet has long been known as a friendly shore-leave spot for Starfleet — even after the murderous Redjac entity was discovered there in 2267. Over a century later, Quark wondered about putting an Argelian massage facility in Garak's old storefront if he didn't want to reopen his shop.",
      name: "Argelians",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "An unnamed stranger of the Argosian species once threw a drink in Benjamin Sisko's face. The incident left a scar on Sisko's chin, not from the Argosian, but from Curzon Dax's ring when the Trill stopped Sisko from retaliating.",
      name: "Argosian",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "A humanoid people whose government, the Argrathi Authority, punishes  offenders by enforced, virtual memories of a prison stay modeled to fit their personalities. Perhaps a bit jumpy, they grew suspicious when O'Brien sincerely asked questions about their technology in 2372 — and then imprisoned him.",
      name: "Argrathi",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Members of this unspecified humanoid species distinguished by white, shaggy hair and a beak-like mouth continuing up into a Klingon-like forehead ridge are seen frequenting DS9. One wealthy native was invited by Quark to the auction of Vash's artifacts in 2369.",
    ...
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        "Jonathan Archer's crew discovered a ship full of Axanar bodies drained of their triglobulin-rich bodily fluid.",
      name: "Axanar",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Planet: Mirror Bajor. The Bajorans in this continuum are a member of the Klingon-Cardassian Alliance, and as such have control of Terok Nor. Even these confident and self-assured Bajorans take time out to explore their pagh.",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Planet: Deneb IV. A humanoid culture who applied for entry into the Federation on stardate 41153.7. However, the Bandi were refused Federation membership due to the discovery that the they had trapped and enslaved another life-form in order to gain entry into the Federation.",
      name: "Bandi",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "A pre-industrial, humanoid civilization residing on Barkon IV, located in the Barkon System.  While retrieving a downed radioactive space probe on their planet, Lieutenant Commander Data encountered the humanoid Barkonians, unwittingly exposing them to radiation poisoning.   ",
      name: "Barkonians",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "A people, otherwise undescribed, who have formalized trade relations with the Romulan Empire. A visual record of trade negotiations from 2365  provided a positive identification of Romulan Senator Pardek and Ambassador Spock four  years later.",
      name: "Barolians",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Planet: name unspecified. A predatory ornithoid life-form to whom Chief of Security Odo was compared on stardate 46853.2.",
      name: "Beneriam Hawk",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Planet: name unspecified. A male of this unspecified race once lost to Jake in a game of Dom-jot, though Jake's girlfriend Marta called the game a hustle.",
      name: "Berellians",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        'Planet: name unspecified. Thanks to the concept of individuality introduced into " Hugh" Borg in 2368, some in the collective assumed the concept too quickly and became disconnected without leadership — a vacuum filled by the maniacal Lore a year later. In contrast to the earlier automatons, these altered Borg took individual names and express emotions of vengeance, fear, and hate until the defeat of Lore and their consolidation into a benign group under Hugh.',
      name: "Borg, altered",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Planet: name unspecified. A humanoid spacefaring race whose freighter crew members, such as the male Tilikia and the female Rionoj, often visit DS9.",
      name: "Boslics",
      episode: "Episode: DS9 452 - Abandoned, The\n",
    },
    {
      serie: "Star Trek: Voyager",
      description:
        "Planet: name unspecified. A race of powerfully telepathic beings, the Botha have the ability to cause intense hallucinations in other beings, completely disabling their functions in reality.  A Bothan attempted to take control of the U.S.S. Voyager, but the telepathic abilities of Kes were sufficient to thwart his attempt.",
      name: "Bothans",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Planet: Bre'el IV. Humanoid members of the Federation whose homeworld became threatened by a falling asteroidal moon until its orbit was restored by the entity known as \"Q.\" Bre'ellians have blunt noses, knobbed crania and deep-set eye pockets with practically no jaw movement when speaking.",
      name: "Bre'ellians",
    ...
    },
    {
      serie: "Star Trek: Voyager",
      description:
        "Civilization originating from a Class-L planet in the Delta Quadrant.  The Briori abducted over 300 humans from Earth in 1937 to enslave them on their homeworld 70,000 light-years away.  Eventually the human slaves revolted, killed their slavemasters, took their technology and weapons, and established a thriving civilization on the Briori planet.  As of 2371, the Briori never returned to their planet.",
      name: "Briori",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Otherwise unspecified ancient culture whose pottery resembles both Taguan and Marlonian, whose fragments Captain Picard once found in a dig on the homeworld.",
      name: "Buronian",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Planet: name unspecified. A species (pronounced \"bye-ZAY-lee-uns') who asked that their scheduled Deep Space Nine conference be moved up a week circa stardate 48467.3.",
      name: "Byzallians",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        'Planet: name unspecified. Space-faring race (pronounced "bye-ZAY-tee-um"), otherwise nondescript, whose six such ships arrived at Deep Space Nine circa stardate 48467.3.',
      name: "Byzatium",
      episode: "Episode: DS9 455 - Defiant\n",
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Humanoid telepathic race who until recently were unaware of spoken language and are being tutored in that area by Lwaxana Troi pending their United Federation of Planets membership application on stardate 47254.1.",
      name: "Cairn",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Origin: Bajor. An animal reputed for a distinct lack of grace — apparently, a beast with two left legs.",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Planet: Chalna. A violent-natured, beast-like race with long  fangs. The people live in anarchy and are carnivorous, even feasting on enemies. A native, Esoqq, is one of Captain Picard's two authentic fellow hostages abducted by aliens who want to study their styles of authority and leadership.  Esoqq  knows of the Mizarians but not the Bolians. The meal patty given the hostages is poisonous to Esoqq, who can go no more than 3 or 4 days without eating.",
      name: "Chalnoth",
      episode: "Episode: TNG 166 - Allegiance\n",
    },
    {
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        'A neutral people who have been at peace for 10 generations and now are "uninvolved in all interstellar matters of consequence."',
      name: "Chrysalians",
      episode: "Episode: TNG 156 - Price, The\n",
    },
    {
      serie: "Star Trek: The Original Series",
      description:
        "An intelligent entity composed of noncorporeal energy in the forum of a sparkling cloud.  It is apparently female gendered, and very inviting when ex-Federation scientist Zefram Cochrane (inventor of the warp drive) is nearby, but capable of equally deadly power when hostile humanoids come too close.",
      name: "Companion, The",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Planet: name unspecified. Space-faring race, otherwise nondescript, with three freighters once vying for the same docking port at Deep Space Nine.",
      name: "Coverians",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        'Origin: a planet near the center of the Galaxy. Galactic explorers (pronounced "sy-THEER-ee-uns") who "stay at home" rather than travel, and bring what they seek to their home world near the center of the Milky Way via instructions encoded in probes.',
      name: "Cytherians",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Planet: Bajor. A unique creature made of energy that is fabricated for five days of every year by the Bajoran Sirah to place two opposing villages against a mythical creature and thereby continue a tradition of unity, rather than strife.",
      name: "Dal'Rok",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "A sure-footed beast, exact origin unspecified, who could have gotten by on the narrow cliffside ledge that Kor did not trust while returning with the Sword of Kahless.",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Planet: Delb II. Although Nellen Tore, assistant to Starfleet Admiral Norah Satie, may not fairly represent the Delbian race, she herself was strikingly tall, had eyebrow creasing, and kept very much to herself.",
      name: "Delbians",
    ...
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        "Left alone with Porthos as the only crew awake while the NX-01 traverses a spatial disturbance lethal to humans and Vulcans, Dr. Phlox spends at least part of his four-plus days jogging while singing a tune from his native Denobula:",
      name: "Denobulan Song",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "A culture and race characterized by harmony, as reflected in the design of the temple that the orphaned Timothy tried to build with Data's help in 2368 aboard the U.S.S. Enterprise NCC-1701-D.",
      name: "Dokkarans",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "A culture capable of a self-induced death-simulation technique that is teachable to and usable by others, including Hupyrians and Ferengi — as servant Maihar'du taught Grand Nagus Zek.",
      name: "Dolbargi",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "A humanoid race related to the Ferengi and, like them, unsensible to telepaths — or at least the Betazeds. The U.S.S. Enterprise crew encountered a Doptherian named Gorta, while searching for the Duras sisters. Constable Odo knows of them from various dealings on space station Deep Space Nine. In appearance their bald heads are covered with a slight mottling, a Ferengi-like nose and a Lyseppian-like extended cranium and a ridge from the rear of the head to the stubby, pointed earflap.",
      name: "Dopterians",
    ...
    },
    {
      serie: "Star Trek: Voyager",
      description:
        "Planet: name unspecified. A tribe with paranormal abilities known to Neelix, otherwise nondescript, who can enter and empty room and see images of people who'd preceded them. They also make a great syrup from tree sap.",
    ...
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        'An otherwise unspecified animal and of unknown habitat, but one whose reputation at least is familiar to Phlox — apparently, for stealth if not unpleasantness. When spooked, he compares it to something "creeping around like a Draxxan cloud viper."',
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Planet: Drema IV. Inhabitants of a pre-spacefaring humanoid peoples, whose ignorance of other worlds threatens Data with a Prime Directive violation when he made contact with a small girl there frightened over the planet's instability in 2365.",
      name: "Dremans",
    ...
    },
    {
      serie: "Star Trek: The Animated Series",
      description:
        "A tripodal, polytheistic race from the planet Edos. An Edosian has three legs, three arms, and three fingers on each hand and foot, with orange skin and a bony face. Lt. Arex is Edosian.",
      name: "Edosian",
    ...
    },
    {
      serie: "Star Trek: The Animated Series",
      description:
        'Because Pandronians are hatched from eggs, Commander Ari bn Bem compared himself to an "eggling" — a newly hatched Pandronian youngster — to express how humbled he felt on stardate 7403.6 (2270) in the presence of the wise disembodied intelligence of Delta Theta III, the entity that guided and protected that world\'s primitive reptilian inhabitants.',
      name: "Eggling",
    ...
    },
    {
      serie: "Star Trek: The Original Series",
      description:
        "Planet: Elas. A fierce humanoid warrior culture at war for years with the neighboring planet of Troyius until both cultures achieved the technology necessary to wipe both themselves and their opponents out. On stardate 4372.5, the U.S.S. Enterprise NCC-1701, under the command of James Kirk, is ordered to act as a neutral courier for the Dolman, Elaan to deliver her to the leader of Troyius in the hopes that their marriage would bring peace to their two worlds.",
      name: "Elasians",
    ...
    },
    {
      serie: "Star Trek: Voyager",
      description:
        "A humanoid species native to the planet Enara Prime in the Delta Quadrant.  A telepathic species, they have an advanced energy conservation technology, although their warp capabilities are not as sophicated. ",
      name: "Enaran",
    ...
    },
    {
      serie: "Star Trek: The Original Series",
      description:
        "Planet: Excalbia. Sentient rock creatures whose planet is normally a bed of molten lava and deadly to humans. The Excalbians are capable of shape-shifting, and use this ability to experiment on the social practices and belief systems of passing alien life-forms.",
      name: "Excalbians",
    ...
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        "Risan celebration, usually held during the Earth month of February.",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Planet: Flaxia. The humanoid space-faring species of Retaya, a hitman associated with the Romulan Tal Shiar who attempted to kill Elim Garak. Flaxian assassins are known to favor a pheromonic sensor, a bomb that's triggered when a person of a particular species gets within range.",
      name: "Flaxians",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Origin: the Alpha Quadrant. An alien species which took an early scientific interest in the discovery of the Bajoran wormhole near the Deep Space Nine space station. This species has also conducted trade business on Deep Space Nine.",
      name: "Frunalian",
      episode: "Episode: DS9 401 - Emissary, Part I\n",
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "A race  targeted in the battle strategies worked out by civilian advisor Kyle Riker at Tokyo Base, before he was invited to be a tactical advisor at Starbase Montgomery.",
      name: "Fuurinkazan",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Planet: name unspecified. Space-faring race which had no ship in Deep Space Nine's local sector at the time of Dukat's kidnapping in 2370 — a clue to confirming that a ship claiming to be of such registry was really Maquis. This form of the word is used only for the natives; adjectival forms display the usage as seen in the example \"Galador ship.\"",
      name: "Galadorans",
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        'A space-faring race known for its "magnificent sweaters," in Garak\'s opinion, and a cultural refusal to acknowledge the concept of time — perhaps the reason its freighter is late one day at Deep Space Nine.',
      name: "Galipotans",
      episode: "Episode: DS9 442 - Wire, The\n",
    },
    {
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Extremely small creatures which act as irritants when they come into contact with humanoid skin, as two unsuspecting Bajorans learned due to a trick played on them by Jake and Nog in 2369.",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        'Origin: space. The last of a unique alien species of living vessels which survived symbiotically with its crew. Apparently, the alien communicated telepathically. Gomtuu (also called "Tin Man"), the last of its kind and extremely lonely, chose to orbit a star which was about to go supernova (stardate 43779.3).  That is, until the depressed Gomtuu found the Betazoid super-telepath, Tam Elbrun, which offered both lonely individuals an ideal relationship.',
      name: "Gomtuu",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "The name of the species of UFP President Jaresh-Inyo, apparently UFP members. Willowy and contemplative, they evolved from herbivorous herd animals and loath violence and confrontation.They require very little sleep.",
      name: "Grazerites",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Planet: name unspecified. A member of this unspecified race often seen around Deep Space Nine is the holographic fighter Constable Odo uses in a vain to let the Jem'Hadar teen learn self-control by venting his skills in appropriate ways. It is not known if the name refers to inexperience or is truly the race nomenclature.",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "An intelligent, hybernating race known to both the Federation and the Sheliak Corporate. Jean-Luc Picard outmaneuvered the hyper-diplomatic Sheliak at their own game when he stipulated that the Grizzelas, with six months of their hybernation cycle still to go, be made the neutral arbitors  in the Tau Cygni V evacuation dispute.",
      name: "Grizzelas",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Origin:  Alpha Quadrant. A species resembling an ostrich, spotted on Deep Space Nine's Promenade on stardate 46853.",
      name: "Gunji jackdaw",
      episode: "Episode: DS9 416 - If Wishes Were Horses\n",
    },
    {
      serie: "Star Trek: Voyager",
      description:
        "Planet: name unspecified. A humanoid race who conquered Talax some 15 years ago, after a war of nearly 10 years. They do not have transporter technology.",
      name: "Haakonians",
    ...
    },
    {
      serie: "Star Trek: The Original Series",
      description:
        "Planet: name unspecified. Both in the mirror universe and in our universe, the Halkans are a humanoid species renowned for their commitment to absolute peace.",
      name: "Halkans",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        'Klingon term for "outsider," and the term used for a race which conquered and pillaged the Klingon homeworld, Kronos.',
      name: "Hur'q, The",
      episode: "Episode: DS9 481 - Sword of Kahless, The\n",
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        'Agressive race of 50 billion warriors of "hideous" intelligence and destruction, destroyed in the blink of an eye by an all-powerful but normally pacifistic Douwd when angered at the death of his human wife during a Husnock attack on their home.',
      name: "Husnock, The",
      episode: "Episode: TNG 151 - Survivors, The\n",
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Origin: Federation Colony. Otherwise unmentioned, this colony of humans exist in another quantum reality which was unintentionally visited by Lieutenant Worf in 2370.",
      name: "Iadara Colony",
    ...
    },
    {
      serie: "Star Trek: Voyager",
      description:
        "Planet: name unspecified. A technological and mostly friendly race known to Neelix who might be able to help rescue a ship trapped in a singularity's event horizon. Tuvok and Chakotay do later make contact with a trade mission via shuttlecraft.",
      name: "Ilidarians",
    ...
    },
    {
      serie: "Star Trek: Voyager",
      description:
        "Planet: Inheritors' planet.  The Inheritors, a humanoid race with pale, paper-white skin and two prominent bumps on their forehead, visited earth 45,000 years ago and implanted a genetic message into the minds of the ancestors of the Native Americans, giving them culture.",
      name: "Inheritors",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        'Planet: Invernia II. Apparently humanoid species (pronounced "ihn-VUHR-nee-ahnz") and linked to the United Federation of Planets by treaty, possibly as members. A native girl about 10 died while a young Dr. Bashir and his father were trapped in a remote area by an ionic storm, but a common native herb could easily have saved her.',
      name: "Invernians",
      episode: "Episode: DS9 426 - Melora\n",
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        "Prah Mantoos offered Dr. Phlox the honor of leading the pilgrims in this incantaion, which is recited prior to the appearance of the Great Plume of Agosoria. The doctor was thrilled to take him up on the request.",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        'A fairly technological world (pronounced "juh-NIGH") whose native humanoid species has evolved from two sexes into a fully androgynous society. It is also located near the first null space pocket ever confirmed and charted, circa stardate 45615. It has at least one moon.',
      name: "J'naii",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Planet: name unspecified. An alien ornithic species with an extremely fearful disposition. Fear has developed notable evolutionary flaws in the species; if frightened, the Joranian ostrich is known to hide its head under water, and remain submerged until it actually drowns itself.",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Origin: Federation colony fallen under Cardassian jurisdiction per the fairly young Federation Cardassian treaty signed in 2370. Some members of this colony strongly opposed relocation by either the Federation or the Cardassians, and now fight to try to retain their homes.",
      name: "Juhraya",
    ...
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        "The pilgrims performed this ritual — a taxing set of exercises, followed by four hours of prayer — during the Time of Agosoria. This particular ritual is meant to purify the body. Dr. Phlox greatly enjoyed participating.",
      name: "Kaana-sah",
      episode: "Episode: ENT 011 - Cold Front\n",
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Planet: Kaelon II. A humanoid race  that overcame its near-xenophobic heritage to finally ask for Federation help after generations failed to devise how to ignite its dying star.",
      name: "Kaelonians",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        'Origin: unknown. An unfriendly group of this race (pronounced "CAL-ee-uns"), once confronted Curzon Dax and Commander Sisko on Rochani III.',
      name: "Kaleans",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "A people who have done the most work in artificial intelligence as of 2367. Although the memory is artificial,  LaForge beleives he spent most of his time while kidnapped by th Romulans at the A.I. conference on Risa in Kanarian seminars.",
      name: "Kanarians",
    ...
    },
    {
      serie: "Star Trek: Voyager",
      description:
        "Planet: name unspecified. Planet visited once by the Bolian Crewman Chell, a former Maquis, who learned their artcraft.",
      name: "Kazleti",
    ...
    },
    {
      serie: "Star Trek: Voyager",
      description:
        "Planet: name unspecified. There are 18 Kazon sects. Any Kazon without a sect is deemed a Goven, or outcast.",
      name: "Kazon",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Planet: name unspecified. The bald, reptilian-skinned space-faring race resembling Liseppians and Dopterians with a skull-encircling ridge are a common trader with Cardassia Prime directly.",
      name: "Kobheerians",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Planet: name unspecified. An intelligent people who destroyed themselves after becoming embroiled in a multi-generational war centuries ago, formerly co-existing with a race of compassionate energy beings who were disgusted by the war's toll and survived it.",
      name: "Koinonians",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Planet: name unspecified. Perhaps a cousin of the lapling shown in Kivas Fajo's collection, this lapling-like creature was brought on board Deep Space Nine during Grand Nagus Zek's first visit in 2369.",
    ...
    },
    {
      serie: "Star Trek: The Animated Series",
      description:
        "This native animal to planet Vulcan is a large, mountain lion-like desert predator with a poisonous bite . It is capable of killing Vulcans and sehlats.",
      name: "Le-Matya",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Planet: Earth. Any species of larvae of any variety of the Terran moth and/or butterfly. The larvae were so called because they exist by burrowing tunnels and habitats into the leaves of plants where they can then safely survive.",
      name: "Leaf Miners",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Planet: Malcus IX. A people whose use of a written language predated the spoken word. They are the major known exception to the rule that most cultures develop a sign or gestural language before a verbal one.",
      name: "Leyrons",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Planet: Ligon II. Well-built, muscular people of dark skin whose culture closely resembles those in feudal Japan and the 13th century Sung Dynasty of China. Ligonians have a highly structured society and live by strict codes of honor; they show  great respect for patience and have a passion for ritualistic displays. The women own the land and so convey power (and partnership) to the men they choose to protect it.",
      name: "Ligonians",
    ...
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        "The long-dead species and culture of a subtrerranean humanoid civilization from a still-fertile world in the Delphic Expanse, based in the city of Urquat. Somehow rendered sterile, the people tried to continue by developing a mutagenic virus that converted victims of any species to Loque'que DNA — a virus that still lives to torment unwitting visitors. Tret's people, adifferent species, have been increasingly obsessed with its eradication (as well as all carriers) for over 60 years.",
      name: "Loque'que",
      episode: "Episode: ENT 055 - Extinction\n",
    },
    {
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        'Humanoid race of envoy Ves Alkar who are empathic with each other but not others encountered on stardate 46041.1. His empathic "dump" ability was not normal to the species.',
      name: "Lumerians",
    ...
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        "A species and culture known to Denobulans and Vulcans by 2153, governed by the Lyssarian Prime Conclave. They have kept the mimetic cloning ability of Lyssarian desert larvae largely a secret to offworlders.",
      name: "Lyssarians",
    ...
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        "Alpha Quadrant species. The M'klexa was one of the warp-capable species that visited the Valakians prior to 2150, but did not offer them warp drive.",
      name: "M'klexa",
    ...
    },
    {
      serie: "Star Trek: The Animated Series",
      description:
        "A flying, screeching creature indigenous to Maravel, and apparently resistant to phaser fire. When Captain Kirk and his landing party are on Lactra VII in 2269 (stardate: 5501.2), Kirk remarks that some attacking sky creatures are similar to them.",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Humanoid and spacefaring race who often frequent DS9, distinguished by a bald head, no visible earlobes, and small stubby spikes about the face. Natives have included the smuggler Regana Tosh and Asoth.",
      name: "Markalians",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Planet: name unspecified. A neutral race who agree to provide asylum to Legate Ghemor after his rescue with Major Kira.",
      name: "Mathenites-61A",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "The otherwise unspecified race of Capt. Bela Tyken, who first discovered and escaped from the energy-draining spatial anomaly named for him.",
      name: "Melthusians",
    ...
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        "Humanoid species indigenous to the planet Valakis. The seemingly primitive Menk are one of two species on the planet; the other is the technologically-advanced Valakians. The Menk are subservient to the Valakians, but are immune to a disease currently ravaging the latter species. Dr. Phlox observed that, while the Valakians are being picked off by the disease, the Menk are in the process of an evolutionary awakening, and will eventually become the dominant species on Valakis.",
      name: "Menk",
      episode: "Episode: ENT 013 - Dear Doctor\n",
    },
    {
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "A race whose donation of special tissue samples is meant to help stop an outbreak of Correllium fever on Nahmi IV circa SD 43807, but almost doomed the Enterprise-D with unintentional invidium contamination.",
      name: "Mikulaks",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        'Planet: name unspecified. A race (pronounced "MEER-a-dorn") in which all are twins who make up a single self as two halves of one being — a "quarrelsome people," according to Quark. Natives are marked by a whitish skin and a high hairline over the face but with a severe widow\'s peak of hair.',
      name: "Miradorn",
      episode: "Episode: DS9 412 - Vortex\n",
    },
    {
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "A race who shared an uneasy truce with Federation member world Bolius IX. With a supposed Bolian Starfleet cadet among his fellow hostages, Picard guessed that someone of this race they might be the captors until it was noted their holding cell was not of Moropan design.",
      name: "Moropa, The",
      episode: "Episode: TNG 166 - Allegiance\n",
    },
    {
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "An indefinable life-form studying the crew of the U.S.S. Enterprise NCC-1701-D in 2365 in the Morgana Quadrant. Nagilum felt justified in his terrifying approach to learning about life and death.",
      name: "Nagilum",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Planet: name unspecified. A humanoid race with partial empathic capabilities; Danny Kwan was half-Napean.",
      name: "Napean",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Planet: Terran colonists originating from Earth. A tribal leader from the Dorvan  Indian colony who is among fellow settlers confronting Gul Evek on Volan III about the attacks on the Federation Merchant  Ship when Commander Sisko and Dukat show up and fellow colonist Bill Samuels is revealed to have died in Cardassian hands. He later helps carry out Samuels' bodybag.",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Origin:  Federation colony near station Deep Space 9 and the Bajoran system. Contacted via subspace link under the orders of science officer Jadzia Dax in 2369, in an attempt to rescue the station's computer system threatened by an invading software life-form.",
      name: "Nehru Colony",
      episode: "Episode: DS9 417 - Forsaken, The\n",
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "A race that culturally prefers efficiency and moderism over any need for history or reverance for older artifacts. A Noophian on Earth would question why so much history had been preserved.",
      name: "Noophian",
    ...
    },
    {
      serie: "Star Trek: Voyager",
      description:
        "Planet: name unspecified. Covert, warlike rivals to the peaceful Baneans with weaponry equal and shielding perhaps superior to Voyager. They once shared the same planet.",
      name: "Numiri",
      episode: "Episode: VOY 108 - Ex Post Facto\n",
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        "According to Trip Tucker, the 200 Nuvian masseuses on Risa have 12 fingers on each hand.  A female Nuvian slave was kept in Zjod's shop on the floating bazaar on the Xanthan homeworld.  ",
      name: "Nuvians",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        'Inhabitants (pronounced "OO-lons") of Marejaretus VI who give thanks during a meal by eating until two large, continuously struck stones are broken.',
      name: "Ooolans",
      episode: "Episode: TNG 145 - Manhunt\n",
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Origin: Devidia II. A snake-like life-form which appeared to possess the same shape-shifting abilities as the Devidians who used it to travel through their time portal.",
      name: "Ophidians",
      episode: "Episode: TNG 226 - Time's Arrow, Part I\n",
    },
    {
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Planet: Delos III. Basically humanoid, this race was kept in virtual addiction to felicium, a native drug, by the neighboring world of Brekkia supposedly to fight off ongoing effects of a plague that was long ago cured. Originally, the Ornarans had long outpaced the Brekkian economy.",
      name: "Ornarans",
      episode: "Episode: TNG 123 - Symbiosis\n",
    },
    {
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "A never-named race of tiny, crustacean-like intelligent beings who attempted to conquer the Federation by infiltrating Starfleet and taking over the bodies of high-ranking officers in 2364, an effort halted by Captain Jean-Luc Picard and exposed by Admiral Norah Satie. The parasites are thought to be extra-galactic.",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Federation planet, Class-M, characterized by two inhabited moons called Alpha Moon and Beta Moon. These moons were often at odds with each other.",
      name: "Pelians",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Planet: name unspecified. A space-faring species, otherwise nondescript, recently known to the United Federation of Planets whom Commander Sisko convinced to try an exchange of ambassadors with the UFP in 2371.",
      name: "Peljenites",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Planet: name unspecified. A space-faring race known for skimping on capital outlay and maintenance. Yates was in their employ when she and Commander Sisko first met at Deep Space Nine, and she blamed her initially outdated 15-year-old transporter model on them.",
      name: "Petrarians",
      episode: "Episode: DS9 469 - Family Business\n",
    },
    {
      serie: "Star Trek: Voyager",
      description:
        'Origin: photostar. Sentient energy beings which lived within a photostar and were inadvertently taken aboard the Voyager in samples. They broke confinement to find refuge in the Holodeck and took "prisoners" by way of materializing the crew users there until ascertaining their "brethren" had been set free.',
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Planet: unknown. An extinct space-faring race, mutually destroyed with the Menthar in the battle of Orelious IX over a thousand years ago (about the time of Earth's late Middle Ages, circa  1300s). They were largely humanoid oxygen-breathers and had a bony head-ridge much like the Klingons. On stardate 43205.6 Captain Picard praised their bridge layout as simple yet elegant and functional.",
      name: "Promellians",
      episode: "Episode: TNG 154 - Booby Trap\n",
    },
    {
      ...
      description:
        "Aurelians were a bipedal, avian race. They stood taller than most Humans, and had bright yellow feathers and blue eyes. Although resembling birds, the Aurelians did have humanoid arms and legs, and were perfectly capable of using devices like a tricorder",
      name: "Aurelians",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Planet: Kesprytt III. This humanoid people formed the minority and highly xenophobic government of the  Prytt Aliiance, led by a prime minister. By 2370 it had claimed Kolrod Island due to its initial disputed settlement, a sore spot with the Kes, which led to Prytt's denial of membership by the UFP.",
      name: "Prytt Alliance",
    ...
    },
    {
      serie: "Star Trek: The Animated Series",
      description:
        'Flying reptiles which existed from Earth\'s Triassic period to the end of the Cretaceous period, pterodactyls are properly called "pterosaurs." In 2269 (stardate 5143.3), when the starship Enterprise returns to the "shore leave" amusement park planet, a landing party is threatened by two attacking pterodactyls. Deep bluish in color, with purple underside of their wings, these pterodactyls are mechanical constructs, like the other "lifeforms" on the planet.',
      name: "Pterodactyls",
    ...
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        "An insect that was known to have drifted for half a light-year trying to return to its homeworld. Phlox cites the story while he and Porthos are the only ones awake aboard the NX-01.",
    ...
    },
    {
      serie: "Star Trek: Voyager",
      description:
        "A race of technophiles interested solely in science and mathematics. They have no interest in the arts, though it appears that they like singing after hearing the holographic Doctor sing opera. However, the Doctor eventually realizes that the Qomar are interested purely in music's mathematical qualities, not the emotional or artistic value.",
      name: "Qomar",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Planet: Ramatis III. Humanoid inhabitants of a planet off the beaten Federation path, whose ruling family line is missing its gene for hearing, much like the Hanovers of Old Earth who suffered from hemophilia.",
      name: "Ramatisians",
      episode: "Episode: TNG 132 - Loud as a Whisper\n",
    },
    {
    ...
    },
    {
      serie: "Star Trek: The Original Series",
      description:
        "Origin: unspecified. This amorphous, pulpous creature rates such a low status to the Klingon people, that name is used to insult people who are thought to be weak. The Klingon, Korax uses this term to insult the U.S.S. Enterprise at Deep Space Station K-7 in 2267.",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Planet: Remmil VI. Sentient native species known to the Federation who spin a crystalline webbing used in building construction, as seen used in their central museum.",
      name: "Remmilians",
      episode: "Episode: DS9 460 - Heart of Stone\n",
    },
    {
      serie: "Star Trek: Voyager",
      description:
        "Planet: Planet Hell.  They can stand upright.  Although they have a skeletal system of a humanoid, they are cold blooded with a reptilian epidermis.  Their young hatch from eggs and thrive on the vapors of the planet.",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Planet: name unspecified. Creators of the Basotile, a type of centuries-old metal sculpture of which Kivas Fajo owned the centuries-old first until his collection was broken up after his arrest in 2366.",
      name: "Rodulans",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        'Origin: Gamma Quadrant. An ancient race (pronounced "sul-tu-NAW")  that was entirely destroyed by a massive power struggle. The events were described in a telepathic archive contained in energy spheres that revealed the story by superimposing the tale onto viewers\' minds — with usually fatal results.',
      name: "Saltah'na",
      episode: "Episode: DS9 418 - Dramatis Personae\n",
    },
    {
    ...
    },
    {
      serie: "Star Trek: The Original Series",
      description:
        "Planet: Scalos. Humanoids who exist in a hyper-accelerated state due to overexposure to radiation.",
      name: "Scalosians",
    ...
    },
    {
      serie: "Star Trek: The Animated Series",
      description:
        "A large, bear-like animal native to Vulcan, sehlats typically possess six-inch fangs. Although sehlats can be ferocious in the wild, Vulcan families frequently domesticate them as pets. Spock had a pet sehlat, which died during his childhood (in 2237, or 8877 on the Vulcan calendar) after sustaining mortal injuries from the poisonous bite of a mountain lion-like desert predator known as a le-matya.",
      name: "Sehlat",
      episode: "Episode: TAS 22003 - Yesteryear\n",
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "A planet in the Beta Renna star system, home to a sentient reptilian race who are deadly enemies of neighboring Antica.",
      name: "Selay",
      episode: "Episode: TNG 108 - Lonely Among Us\n",
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Planet: Serilia (conjectured). A race, otherwise unspecified, whose ambassador's impending visit to Deep Space Nine circa stardate 48423 is the focus of security arrangements being made by Constable Odo.",
      name: "Serilians",
      episode: "Episode: DS9 454 - Meridian\n",
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        "A word in the Novan languge that means falsehood, deception or nonsense.",
      name: "Shale",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Another expression for 'changeling.' Before speaking of his illegal cloaking device for sale in the bar, Quark knocks on everything solid in view — glasses, table, chairs, tray — to make sure it's not a morphed Constable Odo listening in.",
      name: "Shapeshifter",
      episode: "Episode: DS9 448 - Search, Part II\n",
    },
    {
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "A species from another time continuum which can assume other forms and uses gravity wells as a nest for its young . Some mistook a Romulan warp core's artificial quantum singularity as a nest, sent the Warbird into distress, and then fractured time when the responding Galaxy-class Enterprise's power transfer beam locked on.",
    ...
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        'Slang for a post-warp generation of humans who live primarily in space — some of their offspring are even born there. Sometimes shortened to "boomer." The Enterprise NX-01\'s Travis Mayweather is a boomer.',
      name: "Space Boomer",
      episode: "Episode: ENT 001 - Broken Bow\n",
    },
    {
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Planet: name unspecified. A sentient species which reproduces by budding, apparently asexual — otherwise nondescript except for the need for a hatchling pond — is represented in Starfleet and on Deep Space Nine by Ensign Vilix'pran, who is reassigned away from the hazardous materials of Cargo Inspection a month before the buds undergo hatching.",
    ...
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        "The stone represents a life of order and control through logic, and was part of a ritual at the Vulcan monastery of P'Jem. Honored guests were invited to touch the stone at the end of their visit.",
      name: "Stone of J'Kah",
    ...
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        "Humanoid species. Their distinguishing physical characteristic is their mottled, greenish-tinted skin. The Suliban are originally from Sector 3641, but their homeworld became unhabitable around the Earth year of 1851, and most of them became nomadic.",
      name: "Suliban",
      episode: "Episode: ENT 001 - Broken Bow\n",
    },
    {
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Only 300 symbionts are available for hosting each year on average. If a host is weak, the personality of the symbiont will overwhelm it. Unless its current Joined Host objects, a prospective Host may request a specific symbiont.",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Origin: Gamma Quadrant. A Gamma Quadrant race who ruled the Skreea for 800 years and killed the matriarchal people's leaders until they in turn were invaded and conquered by some \"member\" of the Dominion — likely the Jem'Hadar, the Dominion's storm troopers.",
      name: "T-Rogorans",
      episode: "Episode: DS9 430 - Sanctuary\n",
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        'Planet: Tagus III. By law, these spacefaring natives had sealed off the famous ruins of their world to outsiders\' research by 2267. The adjective form, as with "Betazoid"/"Betazed," is "Taguan."',
      name: "Tagans",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Planet: Talarian homeworld. A species of indigenous arachnid, apparently with legs that grow to a half a meter in length.",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Alpha Quadrant race whose Tallonian crystals are illegal anywhere but on their world.",
      name: "Tallonians",
      episode: "Episode: DS9 475 - Hippocratic Oath\n",
    },
    {
    ...
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        "Humanoid species. The Tandarans are suspicious of all Suliban because of the actions of the Cabal, and built a detention center where innocent Suliban civilians were imprisoned.",
      name: "Tandarans",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Planet: Tanuga IV. Space-aware, technological humanoids distinguished mainly by Vulcan-like upswept eyebrows and two to three successive V-shaped ridges on the forehead that echo the brow line. In 2366, both genders prefered stiffly upswept hairstyles.",
      name: "Tanugans",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        'Planet: name unspecified. A people (pronounced "tair-uh-HONG-ee-uns") who are naturally gullible — at least according to Quark, who shrugs off Grand Nagus Zek\'s praise at selling their unwitting government two defective warp drives with his cousin Barbo, whom he later turned in to the authorities. They do practice imprisonment as a criminal punishment.',
      name: "Tarahongians",
      episode: "Episode: DS9 411 - The Nagus\n",
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Planet: Tarchannen III. Non-sentient humanoid race, frightened by normal light and visitors who are visible to humanoid eyes only under ultraviolet light. Their species propagated by using a DNA strand implant in an alien host's thymus to reproduce via genetic metamorphosis, which can take years to gestate. The onset of symptoms can vary in time from days to only an hour.",
      name: "Tarchannens",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "A humanoid, spacefaring race believed extinct in the aftermath of a plague until a band of eight aboard a small ship showed up at Haven in 2364 seeking an isolated site to take advantage of the planet's supposed recuperative powers. They were joined by Dr. Wyatt Miller who hoped to finally find a cure.",
      name: "Tarellians",
      episode: "Episode: TNG 105 - Haven\n",
    },
    {
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Origin: unspecified. A creature which Guinan described as her own imaginary friend in childhood.",
    ...
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        'A humanoid culture of the Delphic Expanse with space travel in the mid-22nd century, physically notable for numerous thin projecting "horns" all about the head. One in 50 million of the natives are born with telepathic abilities and exiled to other worlds by the fearful public, who consider them a threat.',
    ...
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        "This treaty between the Andorians and the Vulcans created borders and buffer zones.",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Humanoid, spacefaring race who belived in the strict separation of the sexes by law, raising their children by the same-sex parent only and keeping them ignorant of the other gender until age 16. Their law provides that a son is property of the mother's new husband, however, in the event of a \"divorce\" — which is accomplished only by the ex-spouse's acceptance of the new suitor's verbal declamation of love to the mate.",
      name: "Tavnians",
    ...
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        "Collection of writings by the legendary Vulcan philosopher Surak. T'Pol gave Archer the complete unabridged translation in order to help the captain relax on his vacation.",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Although LaForge's memory of hopping a ride on a Teldarian cruiser with his shuttlepod to catch up with the Enterprise-D was a false one implanted by Romulans, it is apparently not an unusual occurrence.",
      name: "Teldarians",
      episode: "Episode: TNG 198 - Mind's Eye\n",
    },
    {
      serie: "Star Trek: The Original Series",
      description:
        "Planet: Tellar. A humanoid species distinguished by a porcine-like snout, stout build, deep set eyes and a characteristically irascible disposition.",
      name: "Tellarites",
      episode: "Episode: TOS 044 - Journey to Babel\n",
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Spices from this Federation-area culture were being offered by Kivas Fajo to a group of Andorians in 2366.",
      name: "Tellurians",
      episode: "Episode: TNG 170 - Most Toys, The\n",
    },
    {
    ...
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        "The Tesnians require six hours of boron gas a day in order to survive. While attempting to dock, a Tesnian ship collided with Enterprise NX-01 and crashed into an asteroid. Malcolm Reed and Trip Tucker discovered the wreckage and believed that the Enterprise itself had been destroyed. Enterprise returned the passengers to their homeworld of Tesnia.",
      name: "Tesnians",
    ...
    },
    {
      serie: "Star Trek: The Original Series",
      description:
        "Planet: Thasus. An advanced, intelligent, noncorporeal race of beings, first encountered on stardate 1533.6 when they made contact with Captain Kirk to retrieve a young humanoid they had given special powers to.",
      name: "Thasians",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "First lifeform from the Gamma Quadrant  to appear on Deep Space 9.  Tosk was a trained target for Hunters from his world.  Miles O'Brien offered Tosk shelter, but Tosk chose to fulfill his duty.",
      name: "Tosk",
      episode: "Episode: DS9 406 - Captive Pursuit\n",
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Mysterious humanoid from Tau Alpha C with the ability to focus space and time. The Traveler expressed an interest in Wesley Crusher and, in 2370, became his guide in a new plane of existence.",
      name: "Traveler",
    ...
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        "The legendary Ambassador V'Lar negotiated this Vulcan treaty at Vulcana Regard. A young T'Pol approached the ambassador during a recess of the second conference to ask questions.",
    ...
    },
    {
      serie: "Star Trek: The Original Series",
      description:
        "Origin: unspecified. A small animal characteristically soft, furry, and pleasing to most humanoids (with the exception of Klingons). Tribbles give off a soft purring sound that is soothing to many.",
      name: "Tribble",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Planet: unspecified. Commonly seen in Federation faciliities such as DS9. A dull brown-skinned race with pointed upswept ears and a long, trunk-like, fleshy protrusion from the back of the skull with a few large dark spots, often draped over the shoulder.",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "A major space-faring race, distinguished in appearance by green scaly skin and two blunt horns at the forehead, whose natives frequent Deep Space Nine. One of its freighters, the Nanut, is due to leave DS9 for a two-year stay in the Gamma Quadrant in early 2370. A typical name is Romah Doek.",
      name: "Tygarians",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Planet: name unspecified. A people who engaged in border wars with the UFP during Sisko's posting as first officer on the U.S.S. Okinawa under Leyton. In 2371 its dictatorial Autarch leader was overthrown by a coup. At least one world is M'kemas III.",
      name: "Tzenkethi",
    ...
    },
    {
      serie: "Star Trek: The Animated Series",
      description:
        "A race of bipedal creatures, ursinoids have brown skins, and resemble a cross between an ape, and a bear, with a dog-like snout. Both male and female ursinoids work as heavy metal miners on the planet Motherlode.",
      name: "Ursinoid",
      episode: "Episode: TAS 22008 - Mudd's Passion\n",
    },
    {
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Origin: unknown. This humanoid space-faring race of the Alpha Quadrant delivered weapons-grade dolomide to the occupying Cardassians on Bajor and were suspected of still doing so in 2369 at DS9, soon after the withdrawal, although they also traded with the  Federation.",
      name: "Valerians",
      episode: "Episode: DS9 418 - Dramatis Personae\n",
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Planet: Valt Minor (or just Valt). Humanoid race who, judging by Chancellor Alrik in late 2368, are much shorter than their Kriosian cousins but in the modern era are less sentimental as a culture. The races do share a dark-spotted skin pattern along the hairline and down the neck and spine, not unlike the majority species of Trill hosts.",
      name: "Valtese",
      episode: "Episode: TNG 221 - Perfect Mate, The\n",
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        'Planet: name unspecified. The otherwise nondescript home (pronounced "van-NOBB-un") of a transport ship raided only two light years from Deep Space Nine, when an artifact similar to one being offered by the Miradorn twins was stolen in 2369.',
      name: "Vanoben",
      episode: "Episode: DS9 412 - Vortex\n",
    },
    {
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Planet: Velara III. Microscopic, intelligent one-celled life-forms living in the fragile subsurface saltwater layer of its homeworld. Discovered by a terraforming team that had disrupted their environment by 2364, the entities' components include silicon, germanium, gallium arsenide, cadmium, selenide sulfide, water, impurities, and sodium salt.",
      name: "Velarans",
    ...
    },
    {
      serie: "Star Trek: Voyager",
      description:
        "Planet: Rakella Prime. Natives who believe that hate is a beast which lives within the stomach — and their greatest mythical hero ate stones for 23 days to kill him.",
      name: "Vok'sha",
      episode: "Episode: VOY 112 - Heroes and Demons\n",
    },
    {
    ...
    },
    {
      serie: "Star Trek: Voyager",
      description:
        "The Voth are an intelligent, space-faring, bipedal saurian species that the USS Voyager encountered in the Delta Quadrant. The crew of that ship determined that the Voth evolved from Earth's dinosaurs. Apparently millions of years ago the Voth's ancestors survived extinction after a cataclysmic meteor or comet impact, developed space-faring technology and left Earth. The Voth travel around in massive city-ships that are several kilometers long.",
      name: "Voth, The",
    ...
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        "Planet: Vulcan. T'Pol lived here before signing on with the Enterprise NX-01. The compound provides housing for the Vulcan delegation to Starfleet, and is located just north of San Francisco.",
      name: "Vulcan",
      episode: "Episode: ENT 001 - Broken Bow\n",
    },
    {
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Planet: name unspecified. An predatory animal life-form  rumored to take great pleasure in the pursuit of its prey. On stardate 46925.1, Constable Odo was heard comparing the romantically persistent Lwaxana Troi to this species.",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "A group in the Ordek Nebula, one of many that the faux-cadet Haro says Picard has put his life on the line for.",
    ...
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        "This is how the Eskans referred to the indigenous shapeshifters they hunted on the rogue planet. The wraiths, who possessed telepathic abilities, could assume various forms. One appeared to Captain Archer as a woman from a Yeats poem, in order to ask for his assistance.",
      name: "Wraiths",
      episode: "Episode: ENT 018 - Rogue Planet\n",
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        "Alpha Quadrant species. The Xarantines attacked the Klingon Bu'Kah's raptor. They were defeated by the Klingons, but a toxin in Xarantine ale infected the entire Klingon crew.",
      name: "Xarantines",
    ...
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        "Perhaps the most patient and reflective of the five Xindi species, they wish to adhere to the original timetable for developing their Earth attack weapon, in defiance of the rush of the Xindi-Insectoids and Xindi-Reptilians upon the appearance of the NX-01 in the Delphic Expanse.",
    ...
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        "The sixth of multiple sentient Xindi species were completely wiped out when Xindus was imploded, due to their airborne nature. The planet's destruction was the last act in a century-old civil war among the species some 120 years before their contact with humans.",
      name: "Xindi-Avians",
    ...
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        "A term used by some for the Xindi-Primate species—perhaps in derision, as Xindi-Reptilian Cmdr. Dolim seems to do when he labels Degra as one.",
      name: "Xindi-Humanoid",
      episode: "Episode: ENT 052 - Expanse\n",
    },
    {
    ...
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        'The Xindi subspecies who, in Xindi Council debate, are among those acting as devil\'s advocate to the more militant Xindi-Reptilians and excitable Insectoids. The superweapon project is under the leadership of scientist Degra, one of the two Xindi-Primates on the Council. Early in the Xindi mission, the species was sometimes referred to as "Xindi-Humanoid."',
      name: "Xindi-Primates",
      episode: "Episode: ENT 053 - Xindi, The\n",
    },
    {
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Planet: Yadera Prime. Origin: Gamma Quadrant. As evidenced by their holographic recreations discovered in 2370, this mostly humanoid and gentle people reflect Terran norms, with distinctive architecture and a yen for light-colored clothing fabrics. Their real forebears were overrun by the Dominion over 390 years earlier.",
      name: "Yaderans",
      episode: "Episode: DS9 436 - Shadowplay\n",
    },
    {
      serie: "Star Trek: Voyager",
      description:
        "Planet: Yallit. A species with three spinal columns, known for its engineers, and known to Neelix.",
      name: "Yallitians",
    ...
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Planet: Yalos. A spacefaring species which breathes an atmosphere incredibly acidic and unable to see red or orangein the visible spectrum.  The visit by an ambassador of this species to Deep Space Nine caused  major refurbishing of his guest quarters, since his atmosphere dissolves the room carpet and it had to be replaced.",
      name: "Yalosians",
      episode: "Episode: DS9 465 - Improbable Cause\n",
    },
    {
      serie: "Star Trek: Deep Space Nine",
      description:
        "Planet: Yelik. Space-faring culture with a transport set for departure from Deep Space Nine in 2370, when Minister Jaro announced  Kira's recall to Bajor.",
      name: "Yelikans",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Planet: Yridia. This wrinkly-skinned alien species famed as information merchants was known to the Vulcans before humans, at least in the altered but impermanent future during Archer's multiphasic parasite infection--where Yerdrin Koss is first met by Tucker and Reed in the Ceti Alpha system in 2165.",
      name: "Yridians",
    ...
    },
    {
      serie: "Star Trek: Enterprise",
      description:
        'Planet: Torothan. Members of Zobral\'s social caste were onced force to wear these to signify their low social standing. Yrotts were burned in celebration of the caste system being abolished. The word also means "to stand apart."',
      name: "Zobral",
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Planet Zalda. Federation race completely humanoid in appearance save for a webbed membrane between the fingers.  As a culture, Zaldans are infuriated by courtesy, viewing it as a form of phony social behavior designed to camouflage true feelings.",
      name: "Zaldans",
      episode: "Episode: TNG 119 - Coming of Age\n",
    },
    {
    ...
    },
    {
      serie: "Star Trek: The Next Generation",
      description:
        "Planet: Zibalia. Kivas Fajo's race. Like him, painting the side of the face may be a widely-held custom.",
      name: "Zibalians",
      episode: "Episode: TNG 170 - Most Toys, The\n",
    },
    {
      serie: "Star Trek: Voyager",
      description:
        "Planet: Wysanti. The Wysanti were a humanoid species in the Delta Quadrant, distinguished by a midline ridge on the forehead. The Wysanti did not believe in saying good-bye. At least a few members of the Wysanti species were assimilated by the Borg.      In 2377, USS Voyager rendezvoused with a Wysanti starship. They offered to take in Azan and Rebi, and the twins accepted. Mezoti also decided to go with them, and wished Icheb would come as well, but he felt his place was on Voyager",
      name: "Wysantis",
