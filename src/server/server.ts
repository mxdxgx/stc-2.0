...
import { DatabaseInitializer } from "../utils/initializeDatabase";
...
createConnection(typeOrmConfig)
    .then(async (connection) => {
        ...
        const dbInitializer: DatabaseInitializer = new DatabaseInitializer();
        await dbInitializer.up(connection.createQueryRunner());
